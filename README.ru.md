...
- 💾 **Сохранённые узлы** — переносите узел подписки в отдельную постоянную память
  (⭐), чтобы он остался доступен **после окончания подписки**. Опциональный
  **авто‑снимок** сам сохраняет ограниченный резервный набор доступных сейчас узлов
  (ручные ⭐ никогда не вытесняются).
